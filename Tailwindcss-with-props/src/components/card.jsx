...
export default function card({ title, dev, newdev }) {
  // console.log("props",title)
  return (
    <div className="container mx-auto flex-set">
      <div className="mb-3 d-flex justify-content-center md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:scale-105 group">
        ...
        <div className="mb-4">
          {dev && ( //the reason using for && oprator if dev is not exits so react never read his propperties and react will be crashe
            <>
          ...
          {dev && (
            <>
              ...
              <p className=" text-white mb-2 group-hover:text-gray-300 transition-colors duration-200">
                {dev.des}
              </p>
            </>
          )}
